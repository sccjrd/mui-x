...
export default function RoomBookings() {
  ...
  const [visibleRoomIds, setVisibleRoomIds] = React.useState<string[]>(
    () => rooms.slice(0, 3).map((r) => r.id),
  );
  const [loadingResourceIds, setLoadingResourceIds] = React.useState<string[]>([]);
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '660px', width: '100%', gap: 8 }}>
